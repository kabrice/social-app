...
SWIFT_CLASS("_TtC16devslopes_social11AppDelegate")
...
SWIFT_CLASS("_TtC16devslopes_social10FancyField")
@interface FancyField : UITextField
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC16devslopes_social9FancyView")
@interface FancyView : UIView
- (void)awakeFromNib;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, weak) IBOutlet CircleView * _Null_unspecified imageAdd;
